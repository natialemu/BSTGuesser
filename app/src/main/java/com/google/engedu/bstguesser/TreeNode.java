...
public class TreeNode {
    ...
    public void insert(int valueToInsert) {
        ...
        while(current != null){
            if(current.getValue() > valueToInsert && current.left != null){
                current = current.left;

            }else if(current.getValue() < valueToInsert && current.right != null){
                current = current.right;
            }else if(current.getValue() > valueToInsert && current.left == null){
